export declare const BEHAVIOR_PRIMITIVES: readonly ["portal", "focus-scope", "dismissable-layer", "selection-group", "toggle-state", "roving-focus", "anchored-positioner", "list-navigation", "calendar-grid", "table-sort", "command-filter", "range-calendar", "hierarchy-state", "chart-scale", "inline-edit", "grid-focus"];
